...
/**
 * An activity representing a list of DashboardItems. This activity has
 ...
 * {@link DashboardItemDetailActivity} representing item details. On tablets,
 * the activity presents the list of items and item details side-by-side using
 * two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link DashboardItemListFragment} and the item details (if present) is a
 * {@link DashboardItemDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link DashboardItemListFragment.Callbacks} interface to listen for item
 * selections.
 */
public class DashboardItemListActivity extends FragmentActivity implements
		DashboardItemListFragment.Callbacks {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (findViewById(R.id.dashboarditem_detail_container) != null) {
			...
			((DashboardItemListFragment) getSupportFragmentManager()
	...
	public void onItemSelected(String id) {
		if (mTwoPane) {
			...
			Intent detailIntent = new Intent(this,
					DashboardItemDetailActivity.class);
